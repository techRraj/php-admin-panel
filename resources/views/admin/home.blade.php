              ...
              <div class="row">
                ...
                <div class="col-sm-6 col-lg-3">
                  <div class="card text-white bg-primary">
                    <div class="card-body pb-0">
                      <div class="text-value-lg">Total Earnings</div>
                      <div>9999 Test Seriess</div>
                    </div>
                ...
                <div class="col-sm-6 col-lg-3">
                  <div class="card text-white bg-info">
                    <div class="card-body pb-0">
                      ...
                      <div class="text-value-lg">Total Earnings in 24 hrs</div>
                      <div>3433 Test Seriess</div>
                    </div>
                    <div class="c-chart-wrapper mt-3 mx-3" style="height:70px;">
                ...
                <div class="col-sm-6 col-lg-3">
                  <div class="card text-white bg-warning">
                    <div class="card-body pb-0">
                      <div class="text-value-lg">Total Wallet Balance</div>
                      <div>3033 Test Seriess</div>
                    </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-7 d-none d-md-block">
                      <button class="btn btn-primary float-right" type="button">
                        <svg class="c-icon">
                          <use xlink:href="{{ asset('public/') }}assets/icons/coreui/free-symbol-defs.svg#cui-cloud-download"></use>
                        </svg>
                      </button>
