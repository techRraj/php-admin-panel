...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">{{ "Create Critical Artist" }}</div>

                <div class="card-body">
                    <form method="POST" id="createForm" action="{{ route('admin.store-critical-artist') }}">
                        @csrf
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-control @error('geners') is-invalid @enderror" name="geners" id="geners">
                                    ...
                                    @foreach ($geners as $gener)
                                        <option value="{{ $gener->id }}" {{ old('geners') == $gener->id ? "selected" : "" }} > {{ $gener->title }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
