        ...
        <ul class="c-sidebar-nav">
            ...
            <li class="c-sidebar-nav-dropdown">
                ...
                <ul class="c-sidebar-nav-dropdown-items">
                    ...
                    <li class="c-sidebar-nav-item">
                        <a class="c-sidebar-nav-link" href="{{ url('/admin/countries1') }}">
                        <i class="nav-icon icon-circle-blank mr-2"></i> Second Countries </a>
                    </li>
                    ...
                    <li class="c-sidebar-nav-item">
                        <a class="c-sidebar-nav-link" href="{{ url('/admin/states2') }}">
                        <i class="nav-icon icon-circle-blank mr-2"></i>seconed States</a>
                    </li>
                    <li class="c-sidebar-nav-item">
